...
class UMSalmanAlaswad_I(UserModel):
    ...
    def fitness(self, individual):
        ...
        #             travel_time = track["distance"] / 1000.0 * (1 / speed)
        #             if nminTT > travel_time:
        #                 nminTT = travel_time
        ...
        #         track["normalized_tt"] = (track["distance"] / 1000.0 * (1 / speed)) / nminTT
        #     for source in individual.newTracks:
        #         for target in individual.newTracks[source]:
        ...
        #                     speed = track["maxspeed"]
        #                 individual.newTracks[source][target][i]["normalized_tt"] = (individual.newTracks[source][target][i][
        #                                                                      "distance"] / 1000.0 * (
        #                                                                              1 / speed)) / nminTT
